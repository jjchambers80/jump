...
// Ticket-level rows of the Orders page (one row per ticket: purchaser,
// attendee, barcode, check-in) — the pre-spec-024 Orders page, shown under
// the "Tickets" toggle. Order-level rows live in OrdersListView.
