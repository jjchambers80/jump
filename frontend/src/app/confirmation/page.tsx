  ...
  const fetchTickets = async () => {
    ...
    try {
      ...
      const response = await api.get<{ tickets: Ticket[] }>(
        `/tickets/confirmation?session_id=${sessionId}`
      );
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">Retrieving your tickets...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-lg shadow-md p-8 max-w-md w-full text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Unable to Retrieve Tickets</h2>
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 text-lg">
              ...
              <span className="font-semibold">{tickets[0]?.customerEmail}</span>
            </p>
          </div>
