...
| `APPLICATIONS_PAYMENTS_ENABLED` | backend | Optional. `true` lets PAID application forms open and accept card-on-file submissions (spec 011 phase 2). Default off: only FREE forms (press, panels) run |
