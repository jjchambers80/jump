...
| 018 | **In progress** — phases 1–2 (Transactions list, search, CSV, refunds; customers / analytics / dashboard / tax report include applications) built 2026-09-18; phase 3 planned | Transactions — org-wide list of ticket orders + application payments, search by email/name/Stripe id, refunds, customers/analytics/tax report include applications, tier change / adjustments / waive / offline payment on applications |
