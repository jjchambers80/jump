...
- [Storefront Header and Footer](features/storefront-header-footer.md) — Minimal storefront chrome: no background or border, one-row header with inline menu from `md`, right-side focus-trapped drawer, skip link, 44 px targets, footer columns + copyright row
