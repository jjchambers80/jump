...
| `frontend/src/components/OrganizationSettings.tsx` | Theme section with **Save theme** button (rendered on `/admin/organization/[orgSlug]`, opened from the org switcher, and on the legacy `/admin/organizations` list) |
