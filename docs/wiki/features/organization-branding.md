...
| `frontend/src/components/OnlineStoreSettings.tsx` | Branding: logo, cover, brand color (rendered on **Online store** `/admin/online-store` for the active org, and on the legacy `/admin/organizations` list) |
