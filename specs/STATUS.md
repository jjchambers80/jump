...
| 019 | Participants — org-wide submissions list, application forms and templates | **Partially implemented** | Plan merged 2026-09-18 (PR #70). Phase 1 built 2026-09-18: sidebar **Participants**, one `SubmissionsTable` for the org-wide and per-event lists, `/admin/applications*` routes, Applications tab listing forms across events. Phase 2 (`ApplicationFormTemplate` snapshots) and phase 3 (tags + check-in) not built. |
