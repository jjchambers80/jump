...
| 018 | Transactions — unified view of ticket orders and application payments | **In progress** | Spec + plan 2026-09-17 (PR #64). Phase 1 (org-wide list, search, CSV, refunds; order refunds now ADMIN) and phase 2 (customers, analytics, dashboard, tax report include application money) built 2026-09-18. Phase 3 planned. Org-wide transactions list + search + refunds, customers/analytics/tax report including applications, tier change / adjustments / waive / offline payment on applications. 013–017 reserved (messaging, floor map, pages, machine access, MCP). |
