...
| 018 | Transactions — unified view of ticket orders and application payments | **Planned** | Spec + plan 2026-09-17 (`018-transactions/spec.md`, `plan.md`, PR #64); not built. Org-wide transactions list + search + refunds, customers/analytics/tax report including applications, tier change / adjustments / waive / offline payment on applications. 013–017 reserved (messaging, floor map, pages, machine access, MCP). |
