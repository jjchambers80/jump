...
| 018 | Transactions — unified view of ticket orders and application payments | **Implemented** | Phases 1-3 built 2026-09-18 (PRs #65, #66 + phase 3): org-wide Transactions list / search / CSV / refunds (order refunds now ADMIN); customers, analytics, dashboard, tax report include application money; tier change, adjustments, waive, offline payment, manual refunds on applications. Org-wide transactions list + search + refunds, customers/analytics/tax report including applications, tier change / adjustments / waive / offline payment on applications. 013–017 reserved (messaging, floor map, pages, machine access, MCP). |
